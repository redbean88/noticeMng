...
@Component
@Aspect
public class NoticeUpdateTimeOfContentAspect {
	Logger logger = LoggerFactory.getLogger(NoticeUpdateTimeOfContentAspect.class);
	
	@Resource(name = "noticeService")
	private NoticeService noticeService;
	
	@Pointcut("@annotation(NoticeUpdateTimeOfContentAnnotation)")
	void getAnnotation(){}
	...
	public void NoticeInsetData(JoinPoint jp) throws Throwable{
		...
		if(noticeVO != null){
			noticeService.updateTimeOfContent(noticeVO);
		}
	}
